   ...
   up: async (queryInterface, Sequelize) => {
         ...
         [
            {
               ...
               image: 'https://www.watchstore.vn/images/collections_home/2024/09/06/resized/small-web-banner-casio-mtp_1725589299.webp',
            },
            {
               category_id: 2,
               name: 'Đồng hồ nữ',
               description: 'Danh mục đồng hồ nữ thời trang',
               image: 'https://www.watchstore.vn/images/collections_home/2024/09/06/resized/small-web-banner-casio-ltp_1725589299.webp',
            },
            {
               category_id: 3,
               name: 'Xu hướng 2025',
            ...
            },
            {
               ...
               image: 'https://www.watchstore.vn/images/collections_home/2024/09/06/resized/small-web-banner-tissot_1725589299.webp',
            },
            {
               category_id: 5,
               name: 'Nổi bật',
               description: 'Bộ sưu tập đồng hồ nổi bật',
               image: 'https://www.watchstore.vn/images/collections_home/2024/09/06/resized/small-web-banner-giong-rolex_1725589710.webp',
            },
            {
               category_id: 6,
               name: 'Treo tường',
               description: 'Bộ sưu tập đồng hồ treo tường',
               image: 'https://www.watchstore.vn/images/products/2024/resized/thiet-ke-chua-co-ten-48-1128295870-41019441-1712499500.webp',
            },
         ],
         {},
      );
      ...
      await queryInterface.bulkInsert(
         ...
         [
            ...
            {
               product_image_id: 1,
               url: `${process.env.SERVER_URL}/uploads/product/product1.png`,
               product_id: 101,
            },
            {
               product_image_id: 2,
               url: `${process.env.SERVER_URL}/uploads/product/product2.png`,
               product_id: 102,
            },
            {
               product_image_id: 3,
               url: `${process.env.SERVER_URL}/uploads/product/product3.png`,
               product_id: 103,
            },
